...
public class PointWorldTest {
	...
	public void testPointEquals() {
		Point p1 = new PointWorld(20., 30., 40.); // on equator
		Point p2 = new PointWorld(20., 30., 40.);
		Assert.assertTrue("P1 is the same as P2", p1.equals(p2));
	}

	@Test
	public void testPointTimeEqualsFalse() {
		Point p1 = new PointWorld(0., 0., 0.); // on equator
		Point p2 = new PointWorld(0., 0., 1.);
	...
	public void testPointTimeEqualsTrue() {
		Point p1 = new PointWorld(0., 0., 0.); // on equator
		Point p2 = new PointWorld(0., 0., 1E-4);
	...
	public void testPointEqualsLocFalse() {
		Point p1 = new PointWorld(0., 0., 0.); // on equator
		Point p2 = new PointWorld(1E-4, 0., 0.); // near equator (11m north)
	...
	public void testPointEqualsLocTrue() {
		Point p1 = new PointWorld(0., 0., 0.); // on equator
		Point p2 = new PointWorld(1E-5, 0., 0.); // near equator (1.1m north)
		Assert.assertTrue("P1 is close enough to P2 in space", p1.equals(p2));
	}

	@Test
	public void testPointEquals2Args() {
		Point p1 = new PointWorld(1., 2.);
		Point p2 = new PointWorld(1., 2., 0.);
